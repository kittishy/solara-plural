...
export const translations = {
  en: {
    ...
    common: {
      ...
      loadErrorDesc: 'Something went wrong loading this. Check your connection and try again.',
      dialog: 'Dialog',
      yes: 'Yes, delete',
    ...
    home: {
      ...
      frontNamesOverflow: '{names} and {count} more',
      beaconLabel: "The system's light",
      passLight: 'Pass the light',
    ...
    front: {
      ...
      addedMember: '{name} added to front.',
      removedMember: '{name} removed from front.',
      title: 'Front',
      now: 'Now',
      ...
      historyEmptyDesc: 'Your past front sessions will show up here. Add one to fill in the gaps.',
      ...
      roleFor: 'Role — {name}',
      noRole: 'No role',
      noRoleDesc: 'Fronting without a specific role',
      setRole: 'Set role',
      tierPrimary: 'Primary',
      tierPrimaryDesc: 'Main headmate in control',
      tierCofront: 'Co-front',
      tierCofrontDesc: 'Actively sharing the front',
      tierCoconscious: 'Co-conscious',
      tierCoconsciousDesc: 'Aware, but not in control',
      tierBackground: 'Background',
      tierBackgroundDesc: 'Present in the background',
      tierGuest: 'Guest',
      tierGuestDesc: 'A visiting headmate',
    },
    pages: {
    ...
    settings: {
      ...
      deleteAccountDesc: 'This will schedule the deletion of your account, all members, notes, front history, friendships, and any associated data.',
    ...
    members: {
      ...
      noFronting: 'No one is fronting right now',
    ...
    notifications: {
      ...
      primer: {
        ...
        b2: 'Never miss a friend request',
    ...
    privacy: {
      ...
      dataPrivateDesc: 'By default, your members, fronting, and notes are only visible to you. You can share selectively with friends.',
      controls: 'Controls',
  ...
  'pt-BR': {
    ...
    common: {
      ...
      loadErrorDesc: 'Algo deu errado ao carregar. Verifique sua conexão e tente de novo.',
      dialog: 'Janela',
      yes: 'Sim, excluir',
    ...
    home: {
      ...
      frontDuration: '{duration}',
      frontNamesOverflow: '{names} e mais {count}',
      beaconLabel: 'A luz do sistema',
      passLight: 'Passar a luz',
      frontNote: 'Nota do front',
      summary: 'De relance',
    },
    front: {
      ...
      updated: 'Front atualizado.',
      editFront: 'Editar front',
      saveChanges: 'Salvar alterações',
      addedMember: '{name} foi adicionado ao front.',
      removedMember: '{name} foi removido do front.',
      title: 'Frente',
      now: 'Agora',
      ...
      historyEmptyDesc: 'Suas sessões de front anteriores vão aparecer aqui. Adicione uma para preencher as lacunas.',
      ...
      roleFor: 'Função — {name}',
      noRole: 'Sem função',
      noRoleDesc: 'No front sem uma função específica',
      setRole: 'Definir função',
      tierPrimary: 'Primário',
      tierPrimaryDesc: 'Membro principal no controle',
      tierCofront: 'Co-front',
      tierCofrontDesc: 'Compartilhando o front ativamente',
      tierCoconscious: 'Co-consciente',
      tierCoconsciousDesc: 'Ciente, mas sem controle',
      tierBackground: 'Em segundo plano',
      tierBackgroundDesc: 'Presente em segundo plano',
      tierGuest: 'Convidado',
      tierGuestDesc: 'Um membro visitante',
    },
    pages: {
    ...
    settings: {
      ...
      deleteAccountDesc: 'Isso vai agendar a exclusão da sua conta, todos os membros, notas, histórico de front, amizades e qualquer dado associado.',
    ...
    members: {
      ...
      noFronting: 'Ninguém está no front agora',
    ...
    notifications: {
      ...
      primer: {
        ...
        b2: 'Nunca perca um pedido de amizade',
    ...
    privacy: {
      ...
      dataPrivateDesc: 'Por padrão, seus membros, fronting e notas só são visíveis para você. Você pode compartilhar individualmente com amigos.',
      controls: 'Controles',
  ...
  es: {
    ...
    common: {
      ...
      loadErrorDesc: 'Algo salió mal al cargar. Revisa tu conexión e inténtalo de nuevo.',
      dialog: 'Ventana',
      yes: 'Sí, eliminar',
    ...
    home: {
      ...
      frontSince: 'Desde {time}',
      frontDuration: '{duration}',
      frontNamesOverflow: '{names} y {count} más',
      beaconLabel: 'La luz del sistema',
      passLight: 'Pasar la luz',
      frontNote: 'Nota del front',
      summary: 'De un vistazo',
    },
    front: {
      pageTitle: 'Rastreador de front',
      ...
      updated: 'Front actualizado.',
      editFront: 'Editar front',
      saveChanges: 'Guardar cambios',
      addedMember: '{name} fue añadido al front.',
      removedMember: '{name} fue quitado del front.',
      title: 'Frente',
      now: 'Ahora',
      ...
      historyEmptyDesc: 'Tus sesiones de front anteriores aparecerán aquí. Agrega una para llenar los huecos.',
      ...
      roleFor: 'Rol — {name}',
      noRole: 'Sin rol',
      noRoleDesc: 'En front sin un rol específico',
      setRole: 'Definir rol',
      tierPrimary: 'Primario',
      tierPrimaryDesc: 'Miembro principal en control',
      tierCofront: 'Co-front',
      tierCofrontDesc: 'Compartiendo el front activamente',
      tierCoconscious: 'Co-consciente',
      tierCoconsciousDesc: 'Consciente, pero sin control',
      tierBackground: 'En segundo plano',
      tierBackgroundDesc: 'Presente en segundo plano',
      tierGuest: 'Invitado',
      tierGuestDesc: 'Un miembro visitante',
    },
    pages: {
    ...
    settings: {
      ...
      deleteAccountDesc: 'Esto agendará la eliminación de tu cuenta, todos los miembros, notas, historial de front, amistades y cualquier dato asociado.',
    ...
    members: {
      ...
      noFronting: 'Nadie está al frente ahora',
    ...
    notifications: {
      ...
      primer: {
        ...
        b2: 'No te pierdas ninguna solicitud de amistad',
    ...
    privacy: {
      ...
      dataPrivateDesc: 'Por defecto, tus miembros, fronting y notas solo son visibles para ti. Puedes compartir selectivamente con amistades.',
      controls: 'Controles',
