...
# experiments/ruby-api/endpoints/members — Members collection endpoints
#
# GET  /members  — list active members for current system
# POST /members  — create a new member
#
# Per-member endpoints: endpoints/members/[id].rb
...
Handler = Proc.new do |req, res|
  ...
  when 'POST'
    ...
    # Parse tags — same logic as lib/members/fields.ts
    raw_tags = body['tags']
